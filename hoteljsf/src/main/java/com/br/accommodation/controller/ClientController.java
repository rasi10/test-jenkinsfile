...
import com.br.accommodation.bean.ClientFacade;
...
public class ClientController implements Serializable {
    ...
    @EJB
    private com.br.accommodation.bean.ClientFacade ejbFacade;
...
//    @PostConstruct
//    public void init() {
//        ejbFacade = new com.br.accommodation.bean.ClientFacade();
//    }
    ...
    public String create() {
        try {
            ...
            current.setCreateDate(Date.from(new Date().toInstant()));  
